...
[Backend README](backend/README.md) -> more added
...
- The tablet view needs improvement. I made a fiew changes while working on the mobile version that made it better, but it needs work.
- Create a colors, font-sizes and font-weights library. These components are scattered through the css files, making it hard to reuse the color pallete and maintain consistency in the text.
- Making the filters a reusable component.
- Create tests.

### How was your experience doing this challenge?

I enjoyed creating a full application. I think having to structure the DB, making the APIs (get and post) and doing the frontend helps showcasing my skills. Although, it did took me quite a bit.
